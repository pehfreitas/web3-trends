        ...
        {view.type === "hot" ? (
          <>
            ...
            <div className="trend-grid">
              {hot.map((t) => (
                <a key={`${t.rank}-${t.name}`} className="trend" href={`https://x.com/search?q=${encodeURIComponent(t.query)}`} target="_blank" rel="noreferrer">
                  <span className="t-rank">{t.rank}</span>
                  <div className="t-body">
                    <span className="t-name">{t.name}</span>
                    {t.volume && <span className="t-vol">{t.volume}</span>}
                  </div>
                  <Move move={t.move} />
                </a>
              ))}
              ...
              {columns.map((col) => (
                <div className="col" key={col.handle}>
                  <div className={`col-head ${col.isClient ? "is-client" : ""}`}>
                    <span className="col-handle">@{col.handle}</span>
